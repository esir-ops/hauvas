...
class StudentDashboardView(LoginRequiredMixin, TemplateView):
    template_name = "student/pages/index.html"
...
class StudentCourseView(TemplateView):
    template_name = "student/pages/course.html"

    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context["title"] = "Courses"
        context["link"] = "courses"
        # TODO: Create a fetch function for getting the enrolled courses of each student
        context["courses"] = courses
        return context


class StudentBookmarkView(TemplateView):
    template_name = "student/pages/bookmarks.html"

    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context["title"] = "Bookmarks"
        context["link"] = "bookmark-announcement"
        # TODO: Create a fetch function for getting the enrolled courses of each student
        context["courses"] = courses
        return context
...
class StudentScheduleView(LoginRequiredMixin, TemplateView):
    template_name = "student/pages/schedule.html"

    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context["title"] = "Schedules"
        context["link"] = "schedule"
        # TODO: Create a fetch function for getting the enrolled courses of each student
        context["courses"] = courses
        return context


class StudentGradeView(LoginRequiredMixin, TemplateView):
    template_name = "student/pages/grades.html"
